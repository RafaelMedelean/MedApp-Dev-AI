...
def select_random_path(path_to_csv="csvs/all_patches_balanced_candidates.csv", path_to_jpegs_folder="/workspaces/MedApp-AI-Dev/sdb2/balanced_candidates_augmented_jpegs"):
