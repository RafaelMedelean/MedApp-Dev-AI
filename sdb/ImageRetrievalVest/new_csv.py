...
if __name__ == "__main__":
    path_to_big_csv = "/workspaces/MedApp-Dev-AI/sdb/ImageRetrievalVest/saving_features/saving_features_balanced_candidates.csv"
    path_to_augmented_jpegs = "/workspaces/MedApp-Dev-AI/sdb2/balanced_candidates_augmented_jpegs"
    path_to_new_csv = "/workspaces/MedApp-Dev-AI/sdb/ImageRetrievalVest/saving_features/saving_features_balanced_candidates_smaller.csv"
