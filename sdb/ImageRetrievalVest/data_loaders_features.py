...
path_to_csv = '/workspaces/MedApp-AI-Dev/sdb2/all_patches_balanced_candidates.csv'#'/sdb/ImageRetrievalVest/csvs/all_patches(crops)_names_labels_smaller_bigger_csv_completed.csv'#'/sdb/LUNA16/all_patches(crops)_names_labels_smaller_csv_completed.csv'

# Define path to images
path_images = '/workspaces/MedApp-AI-Dev/sdb2/balanced_candidates'#'/sdb/LUNA16/64x45x45_all_patches_smaller_csv_completed/'
